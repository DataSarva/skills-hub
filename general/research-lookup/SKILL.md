...
description: "Look up current research information using parallel-cli search, the Parallel Chat API, or Perplexity sonar-pro-search. Use for finding papers, gathering research data, and verifying scientific information."
